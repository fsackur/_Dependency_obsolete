function Get-BranchingManifestFinder
{
    <#
        .SYNOPSIS
        ...
        .EXAMPLE
        Get-BranchingManifestFinder -ModulePath 'C:\dev'
    ...
    end
    {
        ...
        $FilesystemFinder = {
            <#
                ...
                .EXAMPLE
                $Finder = Get-BranchingManifestFinder -ModulePath 'C:\dev'
            ...
            foreach ($ModuleRoot in $ModulePath)    # ModulePath is bound from parent scope by GetNewClosure()
            {
                ...
                $Checkout = git checkout $Branch *>1
